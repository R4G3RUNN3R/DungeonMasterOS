...
| Ravenloft: The Horrors Within | Domains of Dread horror anthology/campaign framework | current D&D rules | varies by domain/adventure | metadata + private import |
...
## Production rule
A title does not count as a completed campaign merely because it has a synopsis or a folder. It counts only when:
