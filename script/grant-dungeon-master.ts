  ...
  JSON.stringify(
    {
      ...
      subscriptionBypass: updated.subscriptionBypass,
      campaignLimitBypass: updated.campaignLimitBypass,
      unlimitedAiTurns: updated.unlimitedAiTurns,
      legacyRole: updated.role,
      legacyIsAdmin: updated.isAdmin,
      legacyUnlimitedTurns: updated.unlimitedTurns,
      tier: updated.tier,
    },
    null,
    2,
