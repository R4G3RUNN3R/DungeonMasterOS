...
const SRD_SOURCES: RemoteSrdSource[] = [
  {
    ...
    dataUrl: "https://cdn.jsdelivr.net/gh/5e-bits/5e-database@main/src/2014/en/5e-SRD-Equipment.json",
  },
  {
    ...
    sourceUrl: OFFICIAL_SRD_URL,
    dataUrl: "https://cdn.jsdelivr.net/gh/5e-bits/5e-database@main/src/2014/en/5e-SRD-Magic-Items.json",
  },
  {
    ...
    sourceUrl: OFFICIAL_SRD_URL,
    dataUrl: "https://cdn.jsdelivr.net/gh/5e-bits/5e-database@main/src/2024/en/5e-SRD-Equipment.json",
  },
  {
    ...
    sourceUrl: OFFICIAL_SRD_URL,
    dataUrl: "https://cdn.jsdelivr.net/gh/5e-bits/5e-database@main/src/2024/en/5e-SRD-Magic-Items.json",
  },
  {
    id: "srd-2024-poisons",
    ruleset: "dnd5e",
    ...
    sourceUrl: OFFICIAL_SRD_URL,
    dataUrl: "https://cdn.jsdelivr.net/gh/5e-bits/5e-database@main/src/2024/en/5e-SRD-Poisons.json",
  },
];
...
function writeDefinition(record: ItemDefinitionRecord): void {
  ...
  getDeleteAliases().run(record.definitionKey);
  const aliases = Array.from(new Set([record.name, ...record.aliases]));
  aliases.forEach((alias, index) => {
    const normalized = normalizeName(alias);
    if (normalized) getInsertAlias().run(record.definitionKey, alias, normalized, 100 - index);
  });
...
// The CDN mirror occasionally has a transient miss fetching from origin; one retry
// after a short pause resolves it far more often than not.
